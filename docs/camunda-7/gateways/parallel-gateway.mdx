...
![Gateway-exercise](/assets/docs/gateways/parallel-gateway/Gateway-exercise.png)

You can download the bpmn diagram <a target="_blank" href="/assets/docs/gateways/parallel-gateway/parallel-gateway.bpmn" download="parallel-gateway.bpmn">here</a>.
...
![Bar Invitation](/assets/docs/gateways/parallel-gateway/ChangeGatewayType.png)
