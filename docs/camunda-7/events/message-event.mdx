...
You can download the bpmn diagram <a target="_blank" href="/assets/docs/events/message-event/process-message-event.bpmn" download="message-event-process.bpmn">here</a>.
