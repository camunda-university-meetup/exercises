...
You can download the bpmn diagram <a target="_blank" href="/assets/docs/events/timer-event/process-timer-event.bpmn" download="timer-event-process.bpmn">here</a>.
