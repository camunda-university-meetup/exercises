...
The solution can be found  <a target="_blank" href="/assets/docs/attached-boundary-events/interrupting/process-attached-interrupting-boundary-event.bpmn" download="process-attached-interrupting-boundary-event.bpmn">here</a>.
