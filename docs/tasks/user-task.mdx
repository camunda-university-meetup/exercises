...
![Process](/assets/docs/user-task/process.png "Process")

You can download the bpmn diagram <a target="_blank" href="/assets/docs/user-task/usertask.bpmn" download="usertask.bpmn">here</a>.
...
![Start Form](/assets/docs/user-task/01-StartForm.png "Start Form")
...
![Start Form](/assets/docs/user-task/02-Assignment.png "Start Form")
